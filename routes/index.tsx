  ...
  return (
    <>
      ...
      <div class="w-full h-full">
        <div class="flex flex-row justify-between items-center shadow-md mb-6 py-6 px-20">
          <div class="flex flex-row items-center">
            <img src={asset("./bux_logo.png")} class="h-16 w-16 mr-6" />
            <ul class="pr-4 font-semibold text-sbbrown">MENU</ul>
            <ul class="pr-4 font-semibold text-sbbrown">REWARDS</ul>
            <ul class="pr-4 font-semibold text-sbbrown">GIFT CARDS</ul>
          </div>
          ...
          <div class="flex flex-row items-center">
            ...
            <button class="border-1 border-black px-3 py-1 rounded-2xl ml-6 font-semibold">
              Sign in
            </button>

            <button class="bg-black text-white px-3 py-1 rounded-2xl ml-4 font-semibold">
              Join Now
            </button>
          </div>
        </div>
